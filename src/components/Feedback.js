        ...
        <>
            ...
            <main className="container-fluid mt-4 px-4 px-md-5 pb-5 pb-sm-0 mainFeedback">
                ...
                <div className="row mt-4 mt-md-5 px-0 px-lg-5 mb-4 mb-sm-0">
                    ...
                    <div className="col-12 col-lg-9 mt-4 mt-md-5 mb-3">
                        <div className="position-relative">
                            <textarea id="textoFeedback" className="w-100 px-4 pt-4 px-sm-5 pt-sm-5" type="text" placeholder="Digite aqui..."></textarea>
                            <div className="position-absolute bottom-0 mb-2 d-flex justify-content-center w-100">
                                <div id="estrelas">
                                    <button onClick={estrela1}><img src={estrelaImg1} alt="estrela"/></button>
                                    <button onClick={estrela2}><img src={estrelaImg2} alt="estrela"/></button>
                                    <button onClick={estrela3}><img src={estrelaImg3} alt="estrela"/></button>
                                    <button onClick={estrela4}><img src={estrelaImg4} alt="estrela"/></button>
                                    <button onClick={estrela5}><img src={estrelaImg5} alt="estrela"/></button>
                                </div>    
                            </div>
                        </div>
                        <div className="d-flex justify-content-center mt-4 mb-5 mb-sm-0">
                            <button id="mandar"><p className="p-3 px-5">Mandar Feedback</p></button>
                        </div>
                    </div>
